...
class SingleSiteNoMatchingMetrics(Metrics):
...
def metrics_from_dataset(data_directory: os.PathLike) -> SingleSiteNoMatchingMetrics:
    ...
    return SingleSiteNoMatchingMetrics(
